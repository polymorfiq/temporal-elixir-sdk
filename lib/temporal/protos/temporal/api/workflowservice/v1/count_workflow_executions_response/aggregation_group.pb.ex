defmodule Temporal.Protos.Temporal.Api.Workflowservice.V1.CountWorkflowExecutionsResponse.AggregationGroup do
  @moduledoc """
  ...
  | # | Name | Type | Notes |
  |---|------|------|-------|
  | 2 | **`count`** | `int64` | `groups` contains the groups if the request is grouping by a field. |
  ...
  ### Additional Notes
    ...
    * `count` (`int64`): `groups` contains the groups if the request is grouping by a field.
