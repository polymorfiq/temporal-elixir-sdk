defmodule Temporal.Protos.Temporal.Api.Workflowservice.V1.RespondActivityTaskCompletedRequest do
  @moduledoc """
  Automatically generated module for RespondActivityTaskCompletedRequest
  ...
  | 2 | **`result`** | `Temporal.Protos.Temporal.Api.Common.V1.Payloads` | The result of successfully executing the activity |
