defmodule Temporal.Protos.Temporal.Api.Workflowservice.V1.PauseWorkflowExecutionRequest do
  ...
  | 1 | **`namespace`** | `string` | Namespace of the workflow to pause. |
  | 5 | **`reason`** | `string` | Reason to pause the workflow execution. |
  | 6 | **`request_id`** | `string` | A unique identifier for this pause request for idempotence. Typically UUIDv4. |
