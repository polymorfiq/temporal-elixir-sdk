defmodule Temporal.Protos.Temporal.Api.Workflowservice.V1.CountActivityExecutionsResponse do
  @moduledoc """
  Automatically generated module for CountActivityExecutionsResponse
  ...
  | 2 | **`groups`** | `Temporal.Protos.Temporal.Api.Workflowservice.V1.CountActivityExecutionsResponse.AggregationGroup` | Contains the groups if the request is grouping by a field. |
  ...
  ### Additional Notes
    ...
    * `groups` (`Temporal.Protos.Temporal.Api.Workflowservice.V1.CountActivityExecutionsResponse.AggregationGroup`): Contains the groups if the request is grouping by a field.
