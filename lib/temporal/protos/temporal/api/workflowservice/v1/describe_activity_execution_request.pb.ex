defmodule Temporal.Protos.Temporal.Api.Workflowservice.V1.DescribeActivityExecutionRequest do
  @moduledoc """
  Automatically generated module for DescribeActivityExecutionRequest
  ...
  | 5 | **`include_outcome`** | `bool` | Include the outcome (result/failure) in the response if the activity has completed. |
  | 6 | **`long_poll_token`** | `bytes` | Token from a previous DescribeActivityExecutionResponse. If present, long-poll until activity |
  | 1 | **`namespace`** | `string` |  |
  | 3 | **`run_id`** | `string` | Activity run ID. If empty the request targets the latest run. |

  ### Additional Notes

    * `long_poll_token` (`bytes`): Token from a previous DescribeActivityExecutionResponse. If present, long-poll until activity
