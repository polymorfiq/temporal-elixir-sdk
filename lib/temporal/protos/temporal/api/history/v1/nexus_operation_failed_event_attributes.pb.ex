defmodule Temporal.Protos.Temporal.Api.History.V1.NexusOperationFailedEventAttributes do
  @moduledoc """
  ...
  | # | Name | Type | Notes |
  |---|------|------|-------|
  | 2 | **`failure`** | `Temporal.Protos.Temporal.Api.Failure.V1.Failure` | Failure details. A NexusOperationFailureInfo wrapping an ApplicationFailureInfo. |
