defmodule Temporal.Protos.Temporal.Api.History.V1.ChildWorkflowExecutionTerminatedEventAttributes do
  @moduledoc """
  Automatically generated module for ChildWorkflowExecutionTerminatedEventAttributes

  ## Fields

  | # | Name | Type | Notes |
  |---|------|------|-------|
  | 4 | **`initiated_event_id`** | `int64` | Id of the `START_CHILD_WORKFLOW_EXECUTION_INITIATED` event which this event corresponds to |
  | 1 | **`namespace`** | `string` | Namespace of the child workflow. |
  | 6 | **`namespace_id`** | `string` |  |
  | 5 | **`started_event_id`** | `int64` | Id of the `CHILD_WORKFLOW_EXECUTION_STARTED` event which this event corresponds to |
