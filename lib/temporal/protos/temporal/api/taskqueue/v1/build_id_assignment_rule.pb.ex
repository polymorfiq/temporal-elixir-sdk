defmodule Temporal.Protos.Temporal.Api.Taskqueue.V1.BuildIdAssignmentRule do
  ...
  | # | Name | Type | Notes |
  |---|------|------|-------|
  | 3 | **`percentage_ramp`** | `Temporal.Protos.Temporal.Api.Taskqueue.V1.RampByPercentage` | This ramp is useful for gradual Blue/Green deployments (and similar) |
  | 1 | **`target_build_id`** | `string` |  |

  ### Additional Notes

    * `percentage_ramp` (`Temporal.Protos.Temporal.Api.Taskqueue.V1.RampByPercentage`): This ramp is useful for gradual Blue/Green deployments (and similar)
