...
**This is an (in progress) Temporal Language SDK for the Elixir programming language, that utilizes an NIF of the [Temporal Core SDK](https://github.com/temporalio/sdk-rust#temporal-core-sdk).**
