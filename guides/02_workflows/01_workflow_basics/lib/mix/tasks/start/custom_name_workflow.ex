defmodule Mix.Tasks.Start.CustomNameWorkflow do
  use Mix.Task
  ...
  def run(args) do
    ...
    {:ok, we} = Client.execute_workflow(client, "my_custom_workflow_type", Enum.map(args, &String.to_integer/1), [
      id: "custom-name-workflow",
